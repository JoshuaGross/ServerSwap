...
if (serverCommand === 'ctrun') {
  serverCommand = 'ctrun';
  serverArgs.unshift('signal,hwerr');
  serverArgs.unshift('-f');
  serverArgs.unshift('none'); // this orphans the contract
  serverArgs.unshift('-l');
}
